...
import main.country.CountryLevel5;
...
public class Level5 {
    public static void main(String[] args) {
        CountryLevel5 country = new CountryLevel5("Great Britain", 27, 23, 17, 67);
    ...
    private static CountryLevel5 updateMedalCount(CountryLevel5 country, int day) {
    ...
    private static CountryLevel5 preserveMedalCount(CountryLevel5 country, int day) {
    ...
    private static void printTable(CountryLevel5 country, int day) {
    ...
    private static void queryMedals(CountryLevel5 country) {
        Scanner sc = new Scanner(System.in);
        String input;
